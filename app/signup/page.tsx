  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="lg:grid lg:grid-cols-2 min-h-screen">
        ...
        <div className="hidden lg:flex bg-gradient-to-br from-blue-600 via-purple-500 to-pink-400 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center p-12 text-center w-full h-full">
            ...
            <div className="bg-black/20 backdrop-blur-sm rounded-3xl p-8 mb-8 border border-white/20">
              <div className="bg-white rounded-2xl overflow-hidden max-w-sm mx-auto">
                ...
                <div className="bg-gradient-to-r from-blue-500 to-purple-500 p-6 text-center">
                  ...
                  <h3 className="text-white font-bold">@newcreator</h3>
                  <p className="text-white/80 text-sm">Getting Started</p>
                </div>
                ...
                <div className="p-4 space-y-3">
                  <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                    ...
                    <span className="font-medium text-gray-900 text-sm">Start Your Journey</span>
                  </div>
                  <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                    <div className="w-6 h-6 bg-black rounded-lg flex items-center justify-center">
                      <span className="text-white text-xs">🎯</span>
                    </div>
                    <span className="font-medium text-gray-900 text-sm">Build Your Brand</span>
                  </div>
                  <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                    <div className="w-6 h-6 bg-black rounded-lg flex items-center justify-center">
                      <span className="text-white text-xs">💫</span>
                    </div>
                    <span className="font-medium text-gray-900 text-sm">Connect & Grow</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="text-white">
              ...
              <p className="text-white/80 text-lg max-w-md">
                Join thousands of creators who trust TarpAI to build their online presence and connect with their audience.
              </p>
            </div>
            ...
            <div className="absolute bottom-20 left-20 bg-white/20 backdrop-blur-sm rounded-2xl p-4 border border-white/30">
              <div className="text-sm text-white">
                <div className="font-semibold">Join</div>
                <div className="text-white/70">10K+ creators</div>
              </div>
            </div>
          </div>
        </div>
