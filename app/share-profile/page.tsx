...
import { getTextColorClass } from '@/config/theme.config';
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            <div className={`sticky top-0 ${theme === 'dark' ? 'bg-black/80' : 'bg-white/80'} backdrop-blur-md border-b ${border.primary} z-10`}>
              <div className="flex items-center justify-between p-4">
                ...
                <h1 className="text-xl font-bold text-black">Share Your Profile</h1>
            ...
            <div className="p-6">
              ...
              {qrCode && (
                <div className="mb-6 flex flex-col items-center">
                  ...
                  <p className={`text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'} text-center mt-4`}>
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <span className={`font-medium ${theme === 'dark' ? 'text-white' : 'text-black'}`}>Copy link</span>
                </button>
                ...
                >
                  ...
                  <span className={`font-medium ${theme === 'dark' ? 'text-white' : 'text-black'}`}>Text your profile</span>
                </button>
                ...
                >
                  ...
                  <span className={`font-medium ${theme === 'dark' ? 'text-white' : 'text-black'}`}>Email your profile</span>
                </button>
                ...
                >
                  ...
                  <span className={`font-medium ${theme === 'dark' ? 'text-white' : 'text-black'}`}>Send another way</span>
                </button>
                ...
                >
                  ...
                  <span className={`font-medium ${theme === 'dark' ? 'text-white' : 'text-black'}`}>Post to LinkedIn</span>
                </button>
                ...
                >
                  ...
                  <span className={`font-medium ${theme === 'dark' ? 'text-white' : 'text-black'}`}>Save QR code to photos</span>
                </button>
                ...
                >
                  ...
                  <span className={`font-medium ${theme === 'dark' ? 'text-white' : 'text-black'}`}>Send QR code</span>
                </button>
              </div>
            </div>
          </div>
